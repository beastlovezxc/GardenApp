...
Item {
    ...
    Component.onCompleted:	{
        currentSeriesName = seriesCollectionList.getName(0)
        console.log("currentSeriesName: " + currentSeriesName)
        currentSeriesIndex = seriesCollectionList.getIndex(0)
        console.log("currentSeriesIndex: " + currentSeriesIndex)
        httpView.getLipsColl(currentSeriesIndex)
    }
    Rectangle {
        id: rec_top_bak
        z: 2
